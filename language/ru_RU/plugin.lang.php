...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['%d email addresses already exist: %s'] = '%d Email уже существует: %s';
$lang['%d email addresses rejected: %s'] = '%d Email адрес отклонен: %s';
$lang['%d users registered'] = '%d пользователи зарегистрированы';
$lang['(one on each line)'] = '(по одному в строку)';
